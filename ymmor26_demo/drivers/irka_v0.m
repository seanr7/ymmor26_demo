function [Ar, Br, Cr, timeBuild] = irka_v0(A, B, C, r, opts)
%IRKA_V0 Reference copy of irka.m before tangential-direction fix.
% Tangential directions are fixed unit vectors (cycling through inputs/outputs)
% rather than being updated from the ROM eigenstructure each iteration.
%
% SYNTAX:
%   [Ar, Br, Cr, timeBuild] = irka_v0(A, B, C, r)
%   [Ar, Br, Cr, timeBuild] = irka_v0(A, B, C, r, opts)
%
% DESCRIPTION:
